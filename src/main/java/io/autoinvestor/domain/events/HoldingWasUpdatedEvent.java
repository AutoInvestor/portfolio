...
public class HoldingWasUpdatedEvent extends Event<HoldingWasUpdatedEventPayload> {
    ...
    protected HoldingWasUpdatedEvent(EventId id,
                                     Id aggregateId,
    ...
    public static HoldingWasUpdatedEvent with(WalletId walletId,
                                              UserId userId,
                                              AssetId assetId,
                                              Amount amount,
    ...
    public static HoldingWasUpdatedEvent hydrate(EventId id,
                                                 Id aggregateId,
                                                 HoldingWasUpdatedEventPayload payload,
                                                 Date occurredAt,
                                                 int version) {
