...
public class PubSubUsersSubscriber {
    ...
    public PubSubUsersSubscriber(WalletCreatedHandler walletCreatedHandler,
        ...
        try {
            ...
            if ("USER_CREATED".equals(event.getType())) {
                if (event.getAggregateId() == null) {
                    log.warn("Malformed event: Skipping USER_CREATED event with missing aggregateId msgId={}", msgId);
                    consumer.ack();
                    return;
                }
